...
const translations = {
  ...
  es: {
    ...
    'wizard.memory.description': 'Crea un juego de memoria personalizado con tus fotos.',
...
export const LanguageProvider = ({ children, initialLocale = 'pt' }: { children: ReactNode; initialLocale?: Locale }) => {
  ...
  const t = useCallback((key: TranslationKey, vars?: Record<string, string | number>) => {
    let translation = (translations as any)[locale]?.[key] || (translations['en'] as any)?.[key] || key;
    if (vars) {
