...
const translations = {
  ...
  en: {
    ...
    'home.howitworks.description': 'Our platform makes it easy to create a personalized digital experience that will touch the one you love.',
    ...
    'home.howitworks.step4.description': 'Share the QR code and watch the emotion as they discover a gift that speaks directly to the heart.',
    ...
    'testimonials.t1.name': 'Lucas & Mari',
    'testimonials.t1.text': 'Dude, for real... she cried her eyes out when she saw it lol. It turned out so perfect, seriously!',
    'testimonials.t2.name': 'Bia & Thiago',
    'testimonials.t2.text': 'Guys, what is this timeline?? We spent ages reminiscing about our trips. Surreal.',
    'testimonials.t3.name': 'Rafa & Ju',
    'testimonials.t3.text': 'I\'m terrible at gift-giving, but this saved me big time. Put it together in 20 mins and it was awesome.',
    'testimonials.t4.name': 'Gui & Lau',
    'testimonials.t4.text': 'The puzzle at the start is genius, she was like \'huh what is this?\' and then loved the surprise.',
    'testimonials.t5.name': 'Matheus & Isa',
    ...
    'testimonials.t11.name': 'Dedé & Lena',
    'testimonials.t11.text': 'Speechless... it looked so professional! It seems like I paid a fortune for a designer.',
    'testimonials.t12.name': 'Léo & Lu',
    ...
    'testimonials.t16.name': 'Di & Yas',
    'testimonials.t16.text': 'The falling hearts... aww so sweet! ❤️ She loved it so much.',
    'testimonials.t17.name': 'Rick & Lê',
    'testimonials.t17.text': 'I used the AI to write the text because I\'m terrible with words and it turned out beautiful.',
    'testimonials.t18.name': 'Serginho & Nick',
    'testimonials.t18.text': 'Simple, fast, and touching. The perfect combo for anyone who wants to surprise.',
    'testimonials.t19.name': 'Fer & Sah',
    ...
    'home.plans.description': 'We have the perfect option to immortalize your moment, with the flexibility you need.',
    ...
    'howitworks.puzzle.title': 'A Personalized Riddle',
    ...
    'login.auth.weak-password': 'Password must be at least 6 characters long.',
    'login.auth.invalid-email': 'The email format is invalid.',
    ...
    'login.auth.google.exists': 'An account already exists with this email. Please sign in using the original method.',
    ...
    'mypages.index.description': 'Searching for your pages requires an index that doesn\'t exist in the database. To fix this, open your browser\'s developer console (F12), find the Firestore error, and click the link provided to create the index.',
    ...
    'publicpage.error.unauthenticated.solution.tip': 'The value for `FIREBASE_PRIVATE_KEY` must be copied exactly as is, including `-----BEGIN PRIVATE KEY-----` and `-----END PRIVATE KEY-----`.',
    ...
    'wizard.puzzle.preview.title': 'A Riddle of Love',
    ...
    'wizard.background.heartColor': 'Heart Color',
