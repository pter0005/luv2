...
.poema-startBtn{
  ...
  padding:clamp(15px,4.2cqw,22px) clamp(30px,12cqw,50px) clamp(17px,4.6cqw,24px);
  white-space:nowrap;
  background:linear-gradient(180deg,rgba(255,190,220,.18) 0%,rgba(180,100,200,.12) 50%,rgba(120,50,170,.15) 100%);
  border:1px solid rgba(255,255,255,.35);color:#fff;
  font-family:'Playfair Display',serif;font-style:italic;font-weight:500;font-size:clamp(16px,5.2cqw,22px);letter-spacing:.02em;
  border-radius:999px;cursor:pointer;
  -webkit-backdrop-filter:blur(18px) saturate(150%);backdrop-filter:blur(18px) saturate(150%);
  box-shadow:0 1px 0 rgba(255,255,255,.40) inset,0 -1px 0 rgba(255,255,255,.10) inset,0 10px 35px rgba(160,50,140,.35),0 0 60px rgba(220,100,180,.20);
  text-shadow:0 1px 2px rgba(50,10,60,.50),0 0 14px rgba(255,200,230,.35);
  transition:transform .3s cubic-bezier(.34,1.56,.64,1),box-shadow .3s ease;
  z-index:10;overflow:hidden;isolation:isolate;
  animation:poemaFadeIn 1s ease .3s both;
}
@keyframes poemaFadeIn{from{opacity:0;transform:translate(-50%,-50%) scale(.96)}to{opacity:1;transform:translate(-50%,-50%) scale(1)}}
...
.poema-startBtn .heart{display:inline-block;margin-left:.4em;color:#ffc6df;text-shadow:0 0 10px rgba(255,180,220,.8)}
...
@media (prefers-reduced-motion:reduce){.poema-text .word{transition:opacity .4s ease;transform:none!important}.poema-startBtn{animation:none;opacity:1}}
`;
}
