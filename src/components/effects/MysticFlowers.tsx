  ...
  return (
    <div className={`fw ${!loaded ? 'not-loaded' : ''}`}>
      <style>{`
        ...
        .fw .flower__line__leaf--3,
        .fw .flower__line__leaf--4,
        .fw .flower__line__leaf--6 {
        ...
        .fw .flower__grass--2 {
          ...
          animation: fw-moving-grass--2 1.5s linear infinite;
        }
        .fw .flower__grass--top {
          width: 7vmin; height: 10vmin;
          border-top-right-radius: 100%;
          border-right: var(--line-w) solid var(--c);
          transform: rotate(-2deg);
        }
        .fw .flower__grass--bottom {
        ...
        .fw .flower__g-long__top {
          width: calc(var(--w) + 1vmin); height: var(--h);
          border-top-right-radius: 100%;
          border-right: 0.7vmin solid var(--c);
          transform: translate(-0.7vmin, 1vmin);
        }
        .fw .flower__g-long__bottom {
        ...
        .fw .flower__g-right .leaf {
          width: 30vmin; height: 50vmin;
          border-top-left-radius: 100%;
          border-left: 2vmin solid #6600aa;
          background-image: linear-gradient(to bottom, transparent, var(--dark-color) 60%);
          -webkit-mask-image: linear-gradient(to top, transparent 30%, #6600aa 60%);
        }
        .fw .flower__g-right--1 { animation: fw-g-right-1 2.5s linear infinite; }
        .fw .flower__g-right--2 {
          left: 5vmin; transform: rotateY(-180deg);
          animation: fw-g-right-2 3s linear infinite;
        }
        .fw .flower__g-right--2 .leaf { height: 75vmin; filter: blur(0.3vmin); opacity: 0.8; }

        .fw .flower__g-front {
          position: absolute; bottom: 6vmin; left: 2.5vmin;
          z-index: 100; transform-origin: bottom center;
          transform: rotate(-28deg) rotateY(30deg) scale(1.04);
          animation: fw-g-front 2s linear infinite;
        }
        .fw .flower__g-front__line {
          width: 0.3vmin; height: 20vmin;
          background-image: linear-gradient(to top, transparent, #6600aa, transparent 100%);
          position: relative;
        }
        .fw .flower__g-front__leaf-wrapper {
          position: absolute; top: 0; left: 0;
          transform-origin: bottom left; transform: rotate(10deg);
        }
        .fw .flower__g-front__leaf-wrapper:nth-child(even) {
          left: 0; transform: rotateY(-180deg) rotate(5deg);
          animation: fw-gfl-left 1s ease-in backwards;
        }
        .fw .flower__g-front__leaf-wrapper:nth-child(odd) {
          animation: fw-gfl-right 1s ease-in backwards;
        }
        ...
        .fw .flower__g-front__leaf {
          ...
          box-shadow: inset 0 2px 1vmin rgba(180,44,252,0.2);
          background-image: linear-gradient(to bottom left, transparent, var(--dark-color)), linear-gradient(to bottom right, #7c15aa 50%, transparent 50%);
          -webkit-mask-image: linear-gradient(to bottom right, #7c15aa 50%, transparent 50%);
          mask-image: linear-gradient(to bottom right, #7c15aa 50%, transparent 50%);
        }

        .fw .flower__g-fr {
          position: absolute; bottom: -4vmin; left: 0;
          transform-origin: bottom left; z-index: 10;
          animation: fw-g-fr 2s linear infinite;
        }
        .fw .flower__g-fr .leaf {
          width: 30vmin; height: 50vmin;
          border-top-left-radius: 100%;
          border-left: 2vmin solid #6600aa;
          -webkit-mask-image: linear-gradient(to top, transparent 25%, #6600aa 50%);
          position: relative; z-index: 1;
        }
        .fw .flower__g-fr__leaf {
          position: absolute; top: 0; left: 0;
          width: 10vmin; height: 10vmin;
          border-radius: 100% 0% 0% 100%/100% 100% 0% 0%;
          box-shadow: inset 0 2px 1vmin rgba(180,44,252,0.2);
          background-image: linear-gradient(to bottom left, transparent, var(--dark-color) 98%), linear-gradient(to bottom right, #cc00ff 45%, transparent 50%);
          -webkit-mask-image: linear-gradient(135deg, #7c15aa 40%, transparent 50%);
        }
      ...
      <div className="flowers">
        ...
        <div className="long-g long-g--1">
          {[['3.6s'],['3.8s'],['4s'],['4.2s']].map(([d],i)=>(
            <div key={i} className="grow-ans" style={{'--d':d}}><div className={`leaf leaf--${i}`}/></div>
          ))}
        </div>
        <div className="long-g long-g--2">
          {[['4s'],['4.2s'],['4.4s'],['4.6s']].map(([d],i)=>(
            <div key={i} className="grow-ans" style={{'--d':d}}><div className={`leaf leaf--${i}`}/></div>
          ))}
        </div>
        <div className="long-g long-g--3">
          {[['4s'],['4.2s'],['3s'],['3.6s']].map(([d],i)=>(
            <div key={i} className="grow-ans" style={{'--d':d}}><div className={`leaf leaf--${i}`}/></div>
          ))}
        </div>
        ...
        <div className="long-g long-g--6">
          {[['4.2s'],['4.4s'],['4.6s'],['4.8s']].map(([d],i)=>(
            <div key={i} className="grow-ans" style={{'--d':d}}><div className={`leaf leaf--${i}`}/></div>
          ))}
        </div>
        <div className="long-g long-g--7">
          {[['3s'],['3.2s'],['3.5s'],['3.6s']].map(([d],i)=>(
            <div key={i} className="grow-ans" style={{'--d':d}}><div className={`leaf leaf--${i}`}/></div>
          ))}
        </div>
