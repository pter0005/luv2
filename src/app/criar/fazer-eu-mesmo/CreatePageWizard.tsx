        ...
        <div className="space-y-6 text-center">
            ...
            {!pixData && (
                <div className="rounded-2xl p-4 relative overflow-hidden"
                    ...
                    <div className="absolute top-0 right-0 px-2.5 py-1 rounded-bl-xl text-[10px] font-black uppercase tracking-wider"
                        style={{ background: 'rgba(37,211,102,0.2)', color: '#4ade80' }}>
                        Recomendado
                    </div>
                    <div className="flex items-start gap-3 mb-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/50 mt-0.5">Enviaremos o link da sua página direto no seu WhatsApp assim que ficar pronto</p>
                        </div>
                    </div>
                    <input
                        type="tel"
                    ...
                    />
                    <p className="text-[10px] text-green-400/50 mt-2">90% dos clientes preenchem — facilita o compartilhamento</p>
                </div>
            )}
