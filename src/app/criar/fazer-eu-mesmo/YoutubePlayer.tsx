       ...
       {hasWindow && <div className="hidden">
        ...
        <div className="flex justify-between items-center px-1 pt-1">
            <div className="flex flex-col max-w-[80%]">
              <h3 className="text-white text-lg sm:text-xl font-bold truncate leading-tight">{songName || ""}</h3>
              <p className="text-zinc-400 text-xs sm:text-sm font-medium truncate">{artistName || ""}</p>
            </div>
            <motion.div 
