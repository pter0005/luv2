  ...
  if (style === 'Simples') {
    return (
      <div className="text-center text-white">
        ...
        <p className="text-4xl font-bold" style={{ color: color }}>{timeLeft.totalDays} dias</p>
      </div>
    );
  }
        ...
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-white/5 rounded-lg">
                    <span className="text-4xl font-bold" style={{ color: color }}>{String(timeLeft.years).padStart(2, '0')}</span>
                    <span className="block text-xs text-muted-foreground">Anos</span>
                </div>
                <div className="p-4 bg-white/5 rounded-lg">
                    <span className="text-4xl font-bold" style={{ color: color }}>{String(timeLeft.months).padStart(2, '0')}</span>
                    <span className="block text-xs text-muted-foreground">Meses</span>
                </div>
                 <div className="p-4 bg-white/5 rounded-lg">
                    <span className="text-4xl font-bold" style={{ color: color }}>{String(timeLeft.days).padStart(2, '0')}</span>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-3 text-white">
        {Object.entries({
          ...
          <div key={unit} className="bg-zinc-800/80 p-3 rounded-lg flex flex-col items-center justify-center aspect-square">
            <span className="text-3xl lg:text-4xl font-bold" style={{ color: color }}>{String(value).padStart(2, '0')}</span>
