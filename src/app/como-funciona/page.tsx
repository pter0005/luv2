    ...
    <div className="relative min-h-screen">
      ...
      <div className="container py-12 md:py-20 text-center">
            ...
            <Card className="card-glow text-left p-6">
                <CardHeader className="p-0">
                    ...
                    <p className="text-muted-foreground text-sm">
                        Você escolhe uma foto especial. O sistema a transforma em um quebra-cabeça que a pessoa amada precisará montar para desvendar a surpresa.
                    </p>
                </CardHeader>
            </Card>
            <Card className="card-glow text-left p-6">
        ...
        <div className="max-w-xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">Arraste as peças para revelar a imagem.</p>
            <Puzzle />
        </div>
