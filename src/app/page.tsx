...
export default function Home() {
  ...
  const timelineDemoEvents = useMemo(() => {
    ...
    const eventsData = [
      { description: "Nosso primeiro encontro", imageUrl: "https://imgur.com/OXZTiYV.png" },
      { description: "Nossa Primeira viagem", imageUrl: "https://imgur.com/DlwrBgW.png" },
      { description: "show do bruno mars", imageUrl: "https://imgur.com/Ejeh5vJ.png" },
      { description: "Nosso primeiro carro juntos", imageUrl: "https://imgur.com/4cJl6lr.png" },
      { description: "Aniversário de 1 ano", imageUrl: "https://imgur.com/m6R0J62.png" },
      { description: "Mudança para nosso cantinho", imageUrl: "https://imgur.com/bXQmqFE.png" },
      { description: "Férias na Disney", imageUrl: "https://imgur.com/5zAqwhQ.png" },
      { description: "O pedido de casamento", imageUrl: "https://imgur.com/Ghg4Fqf.png" },
      { description: "Fim de ano na praia", imageUrl: "https://imgur.com/cBOYaXM.png" },
      { description: "Aniversário de 2 anos", imageUrl: "https://imgur.com/umW7vdJ.png" }
    ];
  ...
  return (
    <>
      <section ref={heroRef} className="relative w-full overflow-hidden flex items-center justify-center min-h-[calc(100vh-5rem)] pt-16 pb-16 md:py-24">
      ...
      <AnimatedSection className="section-padding bg-card/50">
        <div className="container max-w-5xl text-center">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className='font-headline font-bold tracking-tight text-3xl md:text-4xl'>Viaje por uma Galáxia de Memórias</h2>
            <p className="text-base text-muted-foreground mt-4 mb-6">
              Navegue por uma linha do tempo 3D, onde cada estrela é um momento especial. Reviva sua história de amor de uma forma que você nunca imaginou.
            </p>
          </div>
          <motion.div
          ...
          >
            <Image
                src="https://imgur.com/X5mmrdK.png"
                alt="Demonstração da Linha do Tempo 3D"
                fill
            ...
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                <div className="text-center text-white p-4 bg-black/50 rounded-lg backdrop-blur-sm">
                    <View className="w-12 h-12 mx-auto mb-4 text-primary" />
                    <h3 className="text-2xl font-bold font-headline">Clique para Explorar</h3>
                    <p className="text-sm opacity-80">Navegue pela demonstração da linha do tempo.</p>
                </div>
            </div>
          </motion.div>
        </div>
      ...
      <AnimatedSection id="recursos" className="section-padding">
        <div className="container max-w-5xl text-center">
          <div className="text-center max-w-2xl mx-auto mb-16">
      ...
      <AnimatedSection id="experiencia" className="section-padding bg-card/50">
